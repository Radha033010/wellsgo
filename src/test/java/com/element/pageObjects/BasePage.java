...
public class BasePage {
	...
	public void waitAndSendKey(WebElement webElement,String value, long timeOutInSeconds)
	{
		waitAndClick(webElement,timeOutInSeconds);
		webElement.clear();
		webElement.sendKeys(value);
	}


	public void waitAndAssert(WebElement webElement, long timeOutInSeconds, String expectedText) {
		WebDriverWait webDriverWait = new WebDriverWait(driver, timeOutInSeconds);
